...
function AssetAvatar({ asset, dark = false }: { asset: AssetOption | null; dark?: boolean }) {
  ...
  const className = dark
    ? "flex h-7 w-7 items-center justify-center rounded-full text-[0.625rem] font-bold text-white md:h-8 md:w-8 md:text-[0.68rem] md:shadow-[0_10px_20px_rgba(0,0,0,0.34)]"
    : "flex h-7 w-7 items-center justify-center rounded-full text-[0.625rem] font-bold text-white md:h-8 md:w-8 md:text-[0.68rem] md:shadow-[0_8px_18px_rgba(0,0,0,0.28)]";
